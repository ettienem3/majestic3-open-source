...
//     							trigger_error('Redis cache connection failed to start: ' . $e->getMessage() . " " . $e->getPrevious(), E_USER_WARNING);
    ...
    private function setIconPacks()
    {
    	$arr_icons = array(
    		...
    		"aim"						=> "icon-aim",
    		"announcement"				=> "icon-broadcast",
			"attachment" 				=> "glyphicon glyphicon-paperclip",
			"back_old" 					=> "icon-exit-left",
			"back"						=> "icon-chevron-left-square",
    		"back_left"					=> "icon-pointer-left2",
			"bar-chart" 				=> "glyphicon glyphicon-signal",
			"behaviours" 				=> "icon-reminder2",
			"bulk"						=> "icon-bullhorn",
    		"campaigns"					=> "icon-slingshot",
			"calendar" 					=> "glyphicon glyphicon-calendar",
    		"city"						=> "glyphicon glyphicon-king",
			"comment" 					=> "icon-reminder2",
			"comms" 					=> "icon-road-sign",
			"contacts"					=> 'icon-users2',
    		"contact_status"			=> "icon-traffic-lights",
			...
			"forms" 					=> "icon-clipboard-text",
			"groups" 					=> "glyphicon glyphicon-globe",
    		"help"						=> "glyphicon glyphicon-question-sign",
			"html_templates_comms" 		=> "icon-palette",
			"html_templates_forms" 		=> "icon-clipboard-text",
			"inactive" 					=> "icon-cross-circle",
			"inbox" 					=> "icon-mailbox-full",
			"info" 						=> "icon-eye",
    		"layout"					=> "icon-pencil-ruler",
			"line-chart" 				=> "icon-site-map",
    		"link"						=> "icon-link",
    		"links"						=> "icon-link",
    		"list"						=> "icon-list3",
			"load" 						=> "icon-bubble-dots",
			"loading" 					=> "glyphicon glyphicon-transfer",
    		"location"					=> "icon-location",
    		"look_feel"					=> "icon-refresh",
    		"minimize"					=> "icon-minus",
			"modify" 					=> "icon-register",
    		"move-vertical"				=> "glyphicon glyphicon-resize-vertical",
			"next" 						=> "glyphicon glyphicon-arrow-right",
    		"newsfeed"					=> "icon-bubble-text",
    		"newsfeed_status"			=> "icon-sync-crossed2",
			"order"						=> "icon-fingers-scroll-vertical",
    		"panels"					=> "icon-pushpin",
			"picture" 					=> "glyphicon glyphicon-picture",
			"pie-chart" 				=> "glyphicon glyphicon-adjust",
    		"preview"					=> "icon-eye",
    		"preview-none"				=> "icon-eye-crossed",
			"print" 					=> "glyphicon glyphicon-print",
			"profile" 					=> "icon-eye",
    		"profile-admin"				=> "icon-satellite",
    		"profiles"					=> "icon-accessibility",
			"refresh" 					=> "glyphicon glyphicon-refresh",
			"report" 					=> "glyphicon glyphicon-stats",
			"roles" 					=> "icon-satellite",
			"save" 						=> "icon-picture2",
			"search" 					=> "icon-magnifier",
			"secure" 					=> "",
			"settings" 					=> "glyphicon glyphicon-cog",
			"sms" 						=> "glyphicon glyphicon-phone-alt",
			"status-error" 				=> "icon-cross-circle",
			"status-info" 				=> "icon-eye",
			"status-success" 			=> "icon-checkmark-circle",
    		"sync"						=> "icon-sync",
			"tables" 					=> "glyphicon glyphicon-th-large",
			"tasks" 					=> "glyphicon glyphicon-tasks",
			"unsecure" 					=> "",
			"tracker"					=> "icon-speed-fast",
			"upload" 					=> "icon-upload2",
    		"user-data-acl"				=> "icon-site-map",
    		"user"						=> "icon-face-detection",
    		"users" 					=> "icon-user",
			"warning" 					=> "glyphicon glyphicon-warning-sign",
    		"webhook"					=> "icon-ligature",
    	);
