...
class PanelContactsGroupStatusCountProcessorModel extends AbstractPanelProcessorModel implements InterfacePanelsProcessor
{
	/**
	 * (non-PHPdoc)
	...
	public function processPanel(FrontPanelsPanelEntity $objPanel)
	{
		...
		$html .= 	"jQuery(function () {
					    jQuery('#$html_id').highcharts({
					        data: {
					            table: 'contacts-vs-status-count'
					        },
					        chart: {
					            type: 'pie'
					        },
		...
		$html .= "</script>";
		$html .= "<table id=\"contacts-vs-status-count\" style=\"display: none;\">";
// 		$html .= 	"<thead>";
// 		$html .= 	"</thead>";
		$html .= 	"<tbody>";
