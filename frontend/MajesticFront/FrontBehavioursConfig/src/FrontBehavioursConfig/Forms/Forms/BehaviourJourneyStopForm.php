...
class BehaviourJourneyStopForm extends FrontCoreSystemFormBase
{
	...
	private function setJavascript()
	{
		...
		$s .=	'jQuery(document).ready(function () {
					//set some labels
					jQuery(".form-element-fk_journey_id").find("label").html("Stop this Journey for the contact completing the form");
					...
					jQuery("#behaviour-form-journey-stop").submit(function () {				
						//set some more values
						jQuery("#behaviour").val("form");
						jQuery("#beh_action").val("__journey_stop");
