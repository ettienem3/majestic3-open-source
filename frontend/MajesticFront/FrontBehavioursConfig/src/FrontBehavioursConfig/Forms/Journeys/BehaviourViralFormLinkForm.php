 ...
 *
 */
class BehaviourViralFormLinkForm extends FrontCoreSystemFormBase
{
	/**
	...
	{
		parent::__construct('behaviour-journey-viral-form-link');
	...
	private function setJavascript()
	{
		...
		$s .=	'jQuery(document).ready(function () {
					...
					jQuery("#behaviour-journey-viral-form-link").submit(function () {
						//set some more values
						jQuery("#behaviour").val("journey");
						jQuery("#beh_action").val("__viral_form_link");
