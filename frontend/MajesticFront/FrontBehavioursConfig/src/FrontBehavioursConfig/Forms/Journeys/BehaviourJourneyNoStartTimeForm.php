 ...
 *
 */
class BehaviourJourneyNoStartTimeForm extends FrontCoreSystemFormBase
{
	/**
	...
	{
		parent::__construct('behaviour-journey-no-start-time');
	...
	private function setJavascript()
	{
		...
		$s .=	'jQuery(document).ready(function () {
					...
					jQuery("#behaviour-journey-no-start-time").submit(function () {				
