 ...
 *
 */
class BehaviourRegistrationStatusChangeJourneyFirstCommForm extends FrontCoreSystemFormBase
{
	/**
	...
	{
		parent::__construct('behaviour-journey-change-status-first-comm');
	...
	private function setJavascript()
	{
		...
		$s .=	'jQuery(document).ready(function () {
					...
					jQuery("#behaviour-journey-change-status-first-comm").submit(function () {
						//set some more values
						jQuery("#behaviour").val("journey");
						jQuery("#beh_action").val("__registration_status_change_journey_first_comm");
